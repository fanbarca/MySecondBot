...
//						}
    ...
    private String productText(String prodId, String userid) throws SQLException {
        ...
        return "<b>" + DataBase.sqlQuery("select "+ a.getLanguage() + " from table0 where id=" + prodId + "", a.getLanguage()) + " "+Lan.links(a.getLanguage(), botName, channelName)+"\n"+
    ...
    private String productText(String prodId) throws SQLException {
        //String emoji = DataBase.sqlQuery("select emoji from table0 where id = "+prodId, "emoji");
        return "<b>" + DataBase.sqlQuery("select russian from table0 where id=" + prodId + "", "russian") + " "+Lan.links(a.getLanguage(), botName, channelName)+"\n"+
