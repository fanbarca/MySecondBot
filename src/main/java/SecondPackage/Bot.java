...
public class Bot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update update) {
        ...
        try {
            if (update.hasMessage()) {
                ...
                if (a.getLanguage()==null&&!(cb.equals("O'zbek")||cb.equals("Русский")||cb.equals("English"))) chooseLanguage(update.getCallbackQuery().getMessage(), true);
    ...
    private void handleCallback(Update update) throws TelegramApiException, SQLException {
        ...
        for (int i = 0; i<DataBase.showAllProducts("id").size(); i++) {
            ...
            if (cb.contains(prodId)||cb.contains(DataBase.showAllProducts(a.getLanguage()).get(i))) {
                ...
                if (DataBase.sqlQueryList("select * from table0", "id").contains(productId)) {
                    ...
                    List<InlineKeyboardButton> row3 = new ArrayList<InlineKeyboardButton>();
                        ...
                        row3.add(new InlineKeyboardButton()
                            ...
                            .setCallbackData(list.get(5)));
                        row3.add(new InlineKeyboardButton()
                            .setText(EmojiParser.parseToUnicode(list.get(6)))
                            .setCallbackData(list.get(6)));
